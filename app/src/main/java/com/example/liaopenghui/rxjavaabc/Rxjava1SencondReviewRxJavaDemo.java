 ...
 * 第二次系统性 过Rxjava
 */
public class Rxjava1SencondReviewRxJavaDemo extends AppCompatActivity {
...
//                Toast.makeText(Rxjava1SencondReviewRxJavaDemo.this, s, Toast.LENGTH_SHORT).show();
//            }
//        };
...
//            @Override
//            public void call() {
//                Toast.makeText(Rxjava1SencondReviewRxJavaDemo.this, "完成", Toast.LENGTH_SHORT).show();
//            }
//        };
//        Observable<String> observable1 = Observable.just("liao1", "peng1", "hui1", "hao1", "shuai1");
...
//                Toast.makeText(Rxjava1SencondReviewRxJavaDemo.this, course.courseName, Toast.LENGTH_SHORT).show();
//            }
//        });
//
//    }
